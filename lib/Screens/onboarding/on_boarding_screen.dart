...
import 'package:matgar/Screens/login/login_screen.dart';
...
class onBoardingScreenState extends State<onBoardingScreen> {
  ...
  List <BoardingModel> boarding = [
    BoardingModel(
      image: 'assets/matgar_assets/assets/image/image1.png',
      text: 'Online Shopping',
      title: 'Best Way to shop',
      body: 'And get the best deals',
    ),
    BoardingModel(
      image: 'assets/matgar_assets/assets/image/image4.jpg',
      text: 'Harry Up Right',
      title: 'Now until it\'s',
      body: 'Too late',
    ),
    BoardingModel(
      image: 'assets/matgar_assets/assets/image/image3.jpg',
      text: 'Order Online',
